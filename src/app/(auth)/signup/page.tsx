...
export default function SignupPage() {
  ...
  const handleSignup = async () => {
    setIsLoading(true);
    // OAuth automatically handles "Create if not exists"
  ...
  return (
    <div className="min-h-screen w-full bg-black flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-zinc-950 border border-white/10 rounded-2xl shadow-2xl shadow-black relative z-10 p-8">
        {/* Header - DIFFERENT TEXT HERE */}
        <div className="flex flex-col items-center text-center mb-8">
          <div className="w-12 h-12 bg-gradient-to-tr from-purple-600 to-blue-600 rounded-xl flex items-center justify-center text-white font-bold text-2xl shadow-lg shadow-purple-900/30 mb-6">
            S
          </div>
          <h1 className="text-2xl font-bold text-white mb-2">
            Create an account
          </h1>
          <p className="text-zinc-400 text-sm">Start Job Hunting.</p>
        </div>
